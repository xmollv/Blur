...
class MainViewController: UIViewController {
    ...
    //MARK: IBOutlets
    private lazy var plusButton = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(self.selectUserImage))
    private lazy var saveButton = UIBarButtonItem(barButtonSystemItem: .save, target: self, action: #selector(self.saveResultingImage))
